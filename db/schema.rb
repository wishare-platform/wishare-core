...
ActiveRecord::Schema[8.0].define(version: 2025_09_28_120127) do
  ...
  create_table "analytics_events", force: :cascade do |t|
    ...
    t.index ["user_id", "event_type", "created_at"], name: "idx_analytics_mobile"
  ...
  create_table "connections", force: :cascade do |t|
    ...
    t.index ["partner_id", "status", "user_id"], name: "idx_connections_reverse_mobile"
    ...
    t.index ["user_id", "status", "partner_id"], name: "idx_connections_mobile"
  ...
  create_table "url_metadata_caches", force: :cascade do |t|
    ...
    t.index ["url", "expires_at"], name: "idx_url_cache_mobile"
  ...
  create_table "wishlist_items", force: :cascade do |t|
    ...
    t.index ["price", "currency", "created_at"], name: "idx_items_trending"
    t.index ["price", "currency", "created_at"], name: "index_wishlist_items_price_currency_time", comment: "Optimizes trending and price-based queries"
    t.index ["priority", "purchased_at"], name: "index_wishlist_items_priority_purchased", comment: "Optimizes priority sorting and purchase tracking"
    t.index ["purchased_by_id"], name: "index_wishlist_items_on_purchased_by_id"
    t.index ["wishlist_id", "status", "created_at"], name: "idx_items_mobile_list"
    t.index ["wishlist_id", "status", "created_at"], name: "index_wishlist_items_list_status_time", comment: "Optimizes item listing with status filtering"
  ...
  create_table "wishlists", force: :cascade do |t|
    ...
    t.index ["visibility", "event_type", "event_date"], name: "idx_wishlists_discovery"
    t.index ["visibility", "event_type", "event_date"], name: "index_wishlists_visibility_event_date", comment: "Optimizes public wishlist discovery by event type"
  end
